...
5. Wish edit and delete update the same wish identity and remove it cleanly.
6. Pet recycle removes the owned pet and refunds stars correctly.
7. Reward redemption fails cleanly when balance is insufficient.
